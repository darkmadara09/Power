...
from Madara import TIGERS, WOLVES, dispatcher
...
from Madara.modules.helper_funcs.misc import split_message
from Madara.modules.helper_funcs.string_handling import split_quotes
from Madara.modules.log_channel import loggable
from Madara.modules.sql import warns_sql as sql
from Madara.modules.sql.approve_sql import is_approved
...
def warn(
    ...
    if user.id in WOLVES:
        if warner:
            message.reply_text("ʜʏᴅʀᴀ ᴀʀᴇ ᴡᴀʀɴ ɪᴍᴍᴜɴᴇ.")
        else:
            message.reply_text(
                "ʜʏᴅʀᴀ ᴛʀɪɢɢᴇʀᴇᴅ ᴀɴ ᴀᴜᴛᴏ ᴡᴀʀɴ ғɪʟᴛᴇʀ!\nI ᴄᴀɴ'ᴛ ᴡᴀʀɴ ʜʏᴅʀᴀ ʙᴜᴛ ᴛʜᴇʏ sʜᴏᴜʟᴅ ᴀᴠᴏɪᴅ ᴀʙᴜsɪɴɢ ᴛʜɪs."
            )
        return
