...
import Madara.modules.sql.kuki_sql as sql
from Madara import BOT_ID, BOT_NAME, BOT_USERNAME, dispatcher
from Madara.modules.helper_funcs.chat_status import user_admin, user_admin_no_reply
from Madara.modules.log_channel import gloggable
...
@user_admin
@gloggable
def Madarachatbot(update: Update, context: CallbackContext):
...
CHATBOTK_HANDLER = CommandHandler("chatbot", Madarachatbot)
