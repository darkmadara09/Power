...
import Madara.modules.sql.log_channel_sql as logsql
import Madara.modules.sql.welcome_sql as sql
from Madara import DEMONS, DEV_USERS, DRAGONS
from Madara import LOGGER as log
from Madara import OWNER_ID, WOLVES, dispatcher, sw
from Madara.modules.helper_funcs.anonymous import AdminPerms, user_admin
from Madara.modules.helper_funcs.chat_status import is_user_ban_protected
from Madara.modules.helper_funcs.chat_status import user_admin as u_admin
from Madara.modules.helper_funcs.misc import build_keyboard, revert_buttons
from Madara.modules.helper_funcs.msg_types import get_welcome_type
    ...
    for new_mem in new_members:
        ...
        if should_welc:
            ...
            # Welcome yourself
                ...
                update.effective_message.reply_text(
                    "ᴛʜᴀɴᴋs ғᴏʀ ᴀᴅᴅɪɴɢ ᴍᴇ! ᴄʜᴇᴄᴋᴏᴜᴛ @Muichiro_support ғᴏʀ ᴍᴏʀᴇ.",
                    reply_to_message_id=reply,
                )
                continue
