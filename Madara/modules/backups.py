...
import Madara.modules.sql.blacklist_sql as blacklistsql
import Madara.modules.sql.locks_sql as locksql
import Madara.modules.sql.notes_sql as sql
import Madara.modules.sql.rules_sql as rulessql
from Madara import EVENT_LOGS as JOIN_LOGGER
from Madara import LOGGER, OWNER_ID, SUPPORT_CHAT, dispatcher
from Madara.__main__ import DATA_IMPORT
...
from Madara.modules.sql import disable_sql as disabledsql
...
def export_data(update, context):
    ...
    with open("YaeMiko{}Backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("YaeMiko{}Backup".format(chat_id), "rb"),
        caption="*sᴜᴄᴄᴇssғᴜʟʟʏ ᴇxᴘᴏʀᴛᴇᴅ ʙᴀᴄᴋᴜᴘ:*\nᴄʜᴀᴛ: `{}`\nᴄʜᴀᴛ ɪᴅ: `{}`\nᴏɴ: `{}`\n\nɴᴏᴛᴇ: ᴛʜɪs `ʏᴀᴇᴍɪᴋᴏ-ʙᴀᴄᴋᴜᴘ` ᴡᴀs sᴘᴇᴄɪᴀʟʟʏ ᴍᴀᴅᴇ ғᴏʀ ɴᴏᴛᴇs.".format(
            chat.title,
            chat_id,
            tgl,
        ),
    ...
    os.remove("Yaemiko{}Backup".format(chat_id))  # Cleaning file
